...
export default function OneBookPage() {
  ...
  return (
    <div>
      {isEdit ? (
        <>
          <input type="text" value={book.title} onChange={handlerTitleChange} placeholder="Название книги" />
          <input type="text" value={book.author} onChange={handlerAuthorChange} placeholder="Автор" />
          <textarea value={book.user_comment} onChange={handlerUserCommentChange} placeholder="Комментарий"/>
          <input type="text" value={book.book_cover} onChange={handlerBookCover} placeholder="Ссылка на обложку" />
